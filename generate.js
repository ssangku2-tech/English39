// 매일 오늘의 패턴 2개 + 단어 5개를 Claude로 생성해 content/YYYY-MM-DD.json 으로 저장
...
구성:
- patterns: 자주 쓰는 영어 회화 패턴 2개. {pattern(영어 패턴), meaning(한국어 의미), example(영어 예문 1문장), example_kr(예문 번역)}
